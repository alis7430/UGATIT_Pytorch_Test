...
class UGATIT(object) :
    ...
    def build_model(self):
        ...
        self.trainA_loader = DataLoader(self.trainA, batch_size=self.batch_size, shuffle=True, num_workers=8)
        self.trainB_loader = DataLoader(self.trainB, batch_size=self.batch_size, shuffle=True, num_workers=8)
        self.testA_loader = DataLoader(self.testA, batch_size=1, shuffle=False, num_workers=8)
        self.testB_loader = DataLoader(self.testB, batch_size=1, shuffle=False, num_workers=8)
